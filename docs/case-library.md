...
| Stepped green BC LLY egress 2026-06-30 | `medium-success / user-corrected rules` | For stepped BC massing, keep facade detail gated, build roof guards from closed border offsets, plan core zones before roof access, and integrate minimal LLY exits into the first-floor facade grid. | `docs/cases/rhino-geometry/stepped-green-bc-llu-egress-2026-06-30.md`, `docs/errors/massing/moscow-bc-massing-error-library.md` |
