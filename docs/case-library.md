...
| Moscow river BC two-footprint massing 2026-06-29 | `medium-success / user-corrected direction` | On user-approved footprints near a river, V02 reached 4/5; user-remodeled V03 promoted stronger rules: shadow reveals under rounded towers, monolithic two-story cut-through connector, and river-facing sloped sides that converge into one upward silhouette. | `docs/cases/rhino-geometry/moscow-river-bc-two-footprints-2026-06-29.md`, `docs/errors/massing/moscow-bc-massing-error-library.md` |
| Stepped green BC LLY egress 2026-06-30 | `accepted after user-corrected rules` | For stepped BC massing, gate facade detail, decide core count before service-zone layout, shift cores only enough to reach operated roofs, integrate four minimal exits into the first-floor grid, and build inset continuous parapet rings. | `docs/cases/rhino-geometry/stepped-green-bc-llu-egress-2026-06-30.md`, `docs/errors/massing/moscow-bc-massing-error-library.md` |
...
| Residential OKN three-block massing 2026-06-26 | `draft active` | For fixed ЖК footprints with a retained OKN/public brick house, preserve footprints and OKN as source authority, use height stepping/top setbacks, and report inferred scale warnings before TEP/code claims. | `docs/cases/rhino-geometry/residential-okn-three-block-massing-2026-06-26.md`, `scripts/rhino/massing/residential_okn/build_residential_okn_massing.py` |
...
table. Use this compact shape when adding a new case entry here:
