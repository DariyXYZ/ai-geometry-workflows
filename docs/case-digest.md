...
| Massing approval before facade detail | Scenario 3 / reference massing | `docs/workflows/massing/tep-massing-scenario-subtypes.md`, `docs/errors/massing/moscow-bc-massing-error-library.md` |
| Operated roofs need clean guard logic | Roof terraces in massing | `docs/errors/massing/moscow-bc-massing-error-library.md` |
