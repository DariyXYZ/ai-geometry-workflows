...
- For C# Script nodes: read `docs/tools/grasshopper/grasshopper-csharp-script-nodes.md`.
...
- For RhinoMCP transport policy: read `docs/research/source-repos/rhinomcp.md`.
